...
架设本服务器的目的在于使小组成员共同探讨、交流 Minecraft 【国际版】的游戏内容，并开展小组内部的联机团建活动。
本服所有成员均运行由 Mojang Studio 和微软许可的正版 Minecraft 副本，并同意由 Mojang Studio 和微软公司签署的《Minecraft 最终用户许可协议》，下称 Mojang EULA (https://www.minecraft.net/en-us/eula)。
本群所讨论的内容与网易游戏公司代理的《我的世界》并无关联。我们均未签署亦或是同意网易的用户协议和服务政策，亦或是下载、安装、持有网易《我的世界》的游戏副本。
本服务器的所有成员均为自愿、自发、主动加入小组，并以学习交流为目的使用由 Mojang Studio 和微软许可的正版 Minecraft 副本，且通过官方正规渠道使用国内合法支付方式购买游玩权限，不存在侵犯网易游戏公司的合法权利的情节。
